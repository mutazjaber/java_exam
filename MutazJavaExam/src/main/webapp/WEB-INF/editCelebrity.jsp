...
<body>
	...
	<div class="mt-2 d-flex justify-content-center">
		<div class="col-4  ">
			...
			<a href="/dashboard">home</a> ${user.userName}
			<form:form action="/celebrities/${celebrity.id }" method="post"
			...
			<div class="col-auto ms-2  ">
				...
				<form:form action="/celebrities/${celebrity.id}/delete"
					method="post">
